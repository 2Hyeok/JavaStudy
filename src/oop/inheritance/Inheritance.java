...
public class Inheritance {
    public static void main(String[] args) {
        ...
        b.aMethod(); // 부모 메소드 사용
        b.bMethod(); // 본인 메소드 사용
        // b.bMethod(); // inheritance.B(부모) 객체로 inheritance.C(자식) 메소드 접근 불가
...
class A {
    ...
    public void aMethod() {
        ...
        // System.out.println("inheritance.A : " + bField); // 컴파일 에러(자식필드 사용 불가
    }
}
...
class B extends A {
    ...
    public void bMethod() {
        ...
        // System.out.println("inheritance.B : " + cField); // 컴파일 에러(자식필드 사용 불가
    }
}
