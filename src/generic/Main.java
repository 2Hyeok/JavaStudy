...
public class Main {
    ...
    public static void main(String[] args){
        ...
        className1.set(1); // integer 타입을 지정해주어서 타입이 지정됨
        ...
        // LimitClassName<String> limitClassName1 = new LimitClassName<String>(); // String타입, 타입 파라미터가 round에 포함안됨
        ...
        HashMap<Integer, String> hashMap = new HashMap<>(); // <Key, Type>
        hashMap.put(1, "홍길동");
    }
}
